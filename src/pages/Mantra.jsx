    ...
    <>
      ...
      <header className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-8 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-2 drop-shadow-lg">✨ Mantras</h1>
          <p className="text-base opacity-90">Sacred mantras and chants for meditation and spiritual practice</p>
        </div>
      </header>
              ...
              {mantras.map((mantra, index) => (
                <article key={index} className="group bg-white dark:bg-gray-700 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden hover:-translate-y-1">
                  ...
                  <div className="p-6">
                    ...
                    <Link to={mantra.link} className="inline-block w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-2 px-4 rounded-lg font-semibold hover:opacity-90 transition text-center group-hover:translate-x-1 focus:outline-none focus:ring-2 focus:ring-orange-400">
                      Explore Mantra →
                    </Link>
                  </div>
                </article>
